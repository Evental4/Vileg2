...
int main()
{
    ...
    btn[7] = {1100,450,"снимок экрана",""};
    btn[8] = {1100,550,"Сохранить",""};
    btn[9] = {1100,600,"Загрузить",""};
    btn[10] = {1100,500,"Справка",""};
    btn[11] = {1100,650,"Выход",""};
    btn[12] = {550,350,"начать",""};
